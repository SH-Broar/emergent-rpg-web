...
<template>
  <svg viewBox="0 0 48 52" aria-hidden="true" class="entity-art" :class="{ hostile: !!entity.creature, person: entity.kind === 'actor' }">
    ...
    <g v-else-if="entity.tags.includes('bed')" data-furniture="bed" stroke="#655e49" stroke-width="2"><path d="M9 40V16h6v6h25v18M9 34h31m-27 6v6m23-6v6" fill="#b19c77"/><path d="M16 24h21v9H16z" :fill="entity.properties.conductivity?'#a8b6bd':entity.properties.moisture?'#91b7af':'#c8b58c'"/><path d="M12 20h9v8h-9" fill="#e2d8b4"/></g>
    <g v-else-if="entity.tags.includes('seat')" data-furniture="seat" stroke="#8d7959" stroke-width="4" fill="#b9a179"><path d="M11 15h26v13H11zm0 18h26m-23 0v12m20-12v12"/></g>
    <g v-else-if="entity.tags.includes('cabinet')" data-furniture="cabinet" stroke="#645b45" stroke-width="2"><path d="M10 12h28v32H10z" fill="#b39d72"/><path d="M10 27h28m-19-7h10m-10 15h10" fill="none"/><path d="M14 44v4m20-4v4"/></g>
    <g v-else-if="entity.tags.includes('table')" data-furniture="table" stroke="#6b624c" stroke-width="3"><path d="M8 25h32v7H8zm5 7v13m23-13v13" fill="#b19b73"/><ellipse cx="25" cy="24" rx="7" ry="3" fill="#d4c6a4"/></g>
