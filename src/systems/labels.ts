...
const CARD_EFFECT_KIND_LABELS: Record<string, string> = {
  'terrain-water': '젖음', 'terrain-fire': '불길', 'terrain-smoke': '연기', lure: '소음 유인',
  'push-enemy': '밀치기', 'pull-enemy': '당기기', 'move-self': '대시', 'grant-airborne': '공중 이동',
  'summon-ally': '아군 소환', 'status-spread': '상태 전파', 'chain-explosion': '연쇄 폭발', 'place-installation': '장판 설치',
  'skip-enemy-action': '적 행동 건너뛰기', 'slow-enemy': '적 둔화', 'delayed-damage': '지연 폭발',
  'random-effect': '무작위 효과', 'damage-per-cards-played': '연속 사용 피해', 'buff-card-instance': '공격 카드 강화',
  'negate-reflect': '피해 흡수·반사', 'bloom-strength': '힘 개화', 'amplify-debuff': '디버프 증폭',
  refill: '마나·손패 보충', 'this-turn-amp': '이번 라운드 증폭', 'damage-per-confine': '궁지 피해',
  damage: '피해',
...
const CARD_EFFECT_DESCRIPTIONS: Record<string, string> = {
  'terrain-water': '해당 칸을 적십니다. 전격 피해 +4, 불을 끄면 연기가 생깁니다.',
  'terrain-fire': '불길 위 모든 전투원은 라운드 끝에 피해 3. 젖은 칸에서는 연기가 됩니다.',
  'terrain-smoke': '먼 마물의 표적을 가립니다. 인접한 마물은 계속 공격합니다.',
  lure: '인접하지 않은 마물을 조준한 소음 위치로 유인합니다.',
  'push-enemy': '적을 밀어냅니다. 벽이나 전투원에 막히면 추가 피해 3.',
  'pull-enemy': '적을 자신 쪽으로 끌어당깁니다.',
  'move-self': '가장 가까운 마물을 기준으로 카드에 정해진 방향으로 이동합니다.',
  'grant-airborne': '다음 이동에서 장애물을 넘어갈 수 있습니다.',
  'summon-ally': '아군 토큰을 소환해 함께 싸웁니다.',
  'status-spread': '명중한 적의 디버프를 인접한 적에게 복사합니다.',
  'chain-explosion': '디버프가 있는 적과 그 주변을 폭발시킵니다.',
  'place-installation': '범위 칸에 지속 효과 장판을 설치합니다.',
  'skip-enemy-action': '적의 다음 행동을 지정한 횟수만큼 건너뜁니다.',
  'slow-enemy': '지정 라운드 동안 적의 행동을 늦춥니다.',
  'delayed-damage': '지정한 지연 뒤 대상에게 폭발 피해를 줍니다.',
  'random-effect': '피해, 취약, 자원 보충, 회복 중 한 효과를 발동합니다.',
  'damage-per-cards-played': '이번 라운드에 먼저 사용한 카드 수에 비례한 피해.',
  'buff-card-instance': '손패의 첫 공격 카드를 이번 전투 동안 강화합니다.',
  'negate-reflect': '이번 라운드 피해를 흡수하고 다음 라운드에 반사합니다.',
  'bloom-strength': '라운드마다 힘을 누적합니다.',
  'amplify-debuff': '대상의 가장 높은 디버프를 늘리고 그 증가량에 비례한 피해.',
  refill: '마나와 손패를 채웁니다. 행동 수는 회복하지 않습니다.',
  'this-turn-amp': '이번 라운드의 카드 효과 수치를 퍼센트만큼 증폭합니다.',
  'damage-per-confine': '상하좌우의 막힌 칸 수에 비례한 피해.',
  damage: '적에게 피해를 줍니다.',
...
const STATUS_DESCRIPTIONS: Record<string, string> = {
  ...
  possession: '빙의 — 주는 피해가 절반이 되고 매 턴 시작에 HP를 잃습니다. 이동 1회당 1씩 줄고, 못 떨치고 나가면 전투 후에도 남습니다. (빙의를 건 적은 사라집니다)',
