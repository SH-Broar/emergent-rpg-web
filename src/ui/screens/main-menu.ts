      ...
      el.innerHTML = `
        <div class="screen menu-screen">
          ...
          <div class="menu-buttons">
            ${hasAutosave ? '' : '<button class="btn btn-primary" data-action="new">1. 새 게임 (새 캐릭터)</button>'}
            ${hasAutosave ? '<button class="btn btn-primary" data-action="connect">1. 접속 (이어하기)</button>' : ''}
