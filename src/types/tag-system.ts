...
const RACE_CAPABILITY_TAGS: Partial<Record<Race, string>> = {
  ...
  [Race.Elf]:         '/organic/bipedal/omnivore/magic_affinity/herb_affinity/nature_sense/',
  [Race.Dwarf]:       '/organic/bipedal/omnivore/mineral_resist/forge_affinity/mineral_digest/strong_stomach/alcohol_resist/',
  [Race.Beastkin]:    '/organic/bipedal/omnivore/keen_senses/raw_affinity/',
  [Race.Harpy]:       '/organic/bipedal/omnivore/flight/bird_diet/',
  [Race.Centaur]:     '/organic/quadruped/omnivore/keen_senses/grain_bonus/',
  [Race.Nekomimi]:    '/organic/bipedal/omnivore/keen_senses/fish_affinity/',
  [Race.Spirit]:      '/ethereal/bipedal/magic_affinity/elemental/potion_only/',
  [Race.Foxkin]:      '/organic/bipedal/omnivore/keen_senses/raw_affinity/',
  [Race.Dragon]:      '/organic/quadruped/omnivore/flight/fire_resist/toxic_immune/mineral_digest/spicy_bonus/',
  [Race.Angel]:       '/ethereal/bipedal/omnivore/flight/holy/magic_affinity/herb_affinity/',
  [Race.Demon]:       '/organic/bipedal/omnivore/dark_affinity/toxic_resist/spicy_bonus/raw_affinity/',
  [Race.Arcana]:      '/construct/bipedal/mineral_digest/toxic_immune/magic_affinity/magical_bonus/',
  [Race.Construct]:   '/construct/bipedal/mineral_digest/toxic_immune/metallic_digest/magical_bonus/',
  [Race.Moth]:        '/organic/flight/omnivore/night_eater/flower_affinity/',
  [Race.Dryad]:       '/organic/bipedal/herb_affinity/plant/nature_sense/flower_affinity/',
  [Race.FallenAngel]: '/ethereal/bipedal/omnivore/flight/dark_affinity/spicy_bonus/',
  [Race.Phantom]:     '/ethereal/bipedal/incorporeal/potion_only/',
  [Race.Merfolk]:     '/organic/bipedal/omnivore/aquatic/fish_affinity/',
  [Race.Goblin]:      '/organic/bipedal/omnivore/scavenger/strong_stomach/raw_affinity/',
  [Race.Vampire]:     '/organic/bipedal/blood_diet/nocturnal/toxic_resist/raw_affinity/',
  [Race.Lamia]:       '/organic/bipedal/omnivore/keen_senses/raw_affinity/cold_blood/',
  [Race.Fairy]:       '/ethereal/flight/omnivore/magic_affinity/flower_affinity/',
  [Race.Arachne]:     '/organic/bipedal/omnivore/web_craft/raw_affinity/',
  [Race.Slime]:       '/amorphous/digest_all/toxic_immune/acid_body/',
  [Race.Lizardfolk]:  '/organic/bipedal/omnivore/cold_blood/raw_affinity/fish_affinity/',
  [Race.Minotaur]:    '/organic/bipedal/omnivore/strength/grain_bonus/',
  [Race.Werewolf]:    '/organic/bipedal/omnivore/keen_senses/nocturnal/raw_affinity/blood_diet/',
  [Race.Halfling]:    '/organic/bipedal/omnivore/strong_stomach/',
  [Race.Siren]:       '/organic/bipedal/omnivore/aquatic/voice/fish_affinity/',
  [Race.Alraune]:     '/organic/bipedal/herb_affinity/plant/nature_sense/flower_affinity/',
};
